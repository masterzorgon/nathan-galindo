...
export const meta = {
  ...
  tag: "blockchain",
  description:
    'Perpetual Futures are derivative financial instruments which allow investors access to the synthetic returns of an asset (typically cryptocurrencies) that offers high yields without requiring the trader to forfeit their position.',
}
